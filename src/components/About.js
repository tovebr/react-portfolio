      ...
      <div className='about-content'>
        <div className='left'>
          ...
          <p>
            ...
            daycare kitchen, and as a cleaner at the daycare. These we're all
            great experiences, the jobs included heavylifting, keeping up to
            code and being there for people.
          </p>
          <p>
            ...
            schedualed the theaterbar and the kitchen and worked there myself
            every now and then. I booked hotels for the preformers. I was the
            link between the productions and out technichians. Every now and
            then I got to leave my desk to help the technicians rebuild the
            theater!
          </p>
          <p>
            ...
            bassplayer and conductor. It's a wonderful job but life on the road
            is a hard one. You have to travel alot to make do as a musician,
            more than i could.
          </p>
        </div>
        <div className='right'>
